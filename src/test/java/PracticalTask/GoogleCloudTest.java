...
//9. Проверить что сумма аренды в месяц совпадает с суммой получаемой при ручном прохождении теста.
    ...
    public void createNewPaste(){
        ...
        String link = "Google Cloud Pricing Calculator";
        googleCloudPage.googleSearch(searchRequest);
        googleCloudPage.clickLink(link);
        googleCloudPage.checkTitle(link);
        googleCloudPricingCalculatorPage = new GoogleCloudPricingCalculatorPage(driver);
        googleCloudPricingCalculatorPage.setQuantity("4");
