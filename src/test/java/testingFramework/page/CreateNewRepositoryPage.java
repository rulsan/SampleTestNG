...
public class CreateNewRepositoryPage extends AbstractPage{
    ...
    private final By labelEmptyRepoSetupOptionLocator = By.xpath("//h3/strong[text()='Quick ..'");
    ...
    public String getCurrentRepositoryName() { return linkCurrentRepository.getText(); }
